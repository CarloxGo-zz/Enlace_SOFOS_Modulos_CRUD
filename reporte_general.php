...
<body>
	<div class="datagrid">
	<form action="reporte_general.php" method="get" accept-charset="utf-8" align="left">
		...
		<table>
			...
			<tfoot>
				<tr><td colspan="15">
					<div id="paging">
						<ul>
							<?php
							if($_REQUEST['fechainicio']!="" and $_REQUEST['fechafin']!=""){
							?>
							<li><span style="font-size:16px;font-weight:300" >Per&iacute;odo: <?php echo '<span style="font-size:20px;color:red";><input type="date" value="'.$_REQUEST['fechainicio'].'" disabled /></span> al <span style="color:red";><input type="date" value="'.$_REQUEST['fechafin'].'" disabled /></span> &nbsp;&nbsp;&nbsp;&nbsp; ';?>
							</span><a href="pdf/ezpdf/reporte_general_pdf.php?fechainicio=<?php echo $_REQUEST['fechainicio'];?>&fechafin=<?php echo $_REQUEST['fechafin'];?>">
			...
			if(isset($_GET['fechainicio']) and isset($_GET['fechafin'])){
				...
				if($fechainicio > $fechafin){
				  header("location: reporte_general.php?error=1");
				}else{
					if($fechafin > date("Y-m-j") || $fechafin > date("Y-m-j")){
						header("location: reporte_general.php?error=3");
					}else{
